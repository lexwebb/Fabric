...
namespace Fabric.Data {
    public class SchemaManager : ISchemaManager {
        ...
        public SchemaManager(FabricDatabase database) {
            _database = database;
            Schemas = new List<DataPageSchema>();

            if (!Directory.Exists(SchemaSubFolderPath)) Directory.CreateDirectory(SchemaSubFolderPath);
        }
        ...
        public void Add(string schemaName, string schemaRawJson) {
            ...
            File.WriteAllText(Path.Combine(SchemaSubFolderPath, $"{schemaName}.json"),
        ...
        public void Delete(string schemaName) {
            ...
            File.Delete(Path.Combine(SchemaSubFolderPath, $"{schemaName}.json"));
        }
